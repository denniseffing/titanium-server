...
//		 me.animationColor = 0xB4;
		 ...
		 me.drawblood = true;
		 me.maxDamage = int(((player->skills[4][SKILL_LEVEL] * 2) + (player->level * 1)+(player->maglevel * 2)) * 0.35f);
		 me.minDamage = int(((player->skills[4][SKILL_LEVEL] * 3) + (player->level * 1)+(player->maglevel * 2)) * 0.70f);
...
//		 me.animationColor = 0xB4;
		 ...
		 me.drawblood = true;
		 me.maxDamage = int(((player->skills[4][SKILL_LEVEL] * 9) + (player->level * 2)+(player->maglevel * 8)) * 0.35f);
		 me.minDamage = int(((player->skills[4][SKILL_LEVEL] * 7) + (player->level * 2)+(player->maglevel * 8)) * 0.70f);
...
//		 me.animationColor = 0xB4;
		 me.damageEffect = NM_ME_HITBY_FIRE;
		 me.drawblood = true;
		 me.maxDamage = int(((player->skills[4][SKILL_LEVEL] * 12) + (player->level * 22)+(player->maglevel * 6)) * 0.35f);
		 me.minDamage = int(((player->skills[4][SKILL_LEVEL] * 12) + (player->level * 18)+(player->maglevel * 6)) * 0.70f);
