...
public:
    ...
    static int luaActionDoPlayerAddMaxCap(lua_State *L);

    static int luaActionDoPlayerAddSkillTry(lua_State *L);

    static int luaActionDoPlayerAddHealth(lua_State *L);

    static int luaActionDoPlayerAddMaxHealth(lua_State *L);

    static int luaActionDoPlayerAddMaxMana(lua_State *L);
