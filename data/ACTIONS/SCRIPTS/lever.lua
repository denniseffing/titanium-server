...
if player1.itemid > 0 and player2.itemid > 0 and player3.itemid > 0 and player4.itemid > 0 then   				player1level = getPlayerLevel(player1.uid)
   				...
   				if player1level >= questlevel and player2level >= questlevel and player3level >= questlevel and player4level >= questlevel then
   					...
   					queststatus3 = getPlayerStorageValue(player3.uid,7000)   					queststatus4 = getPlayerStorageValue(player4.uid,7000)
   					...
   					if queststatus1 == -1 and queststatus2 == -1 and queststatus3 == -1 and queststatus4 == -1 then
  						...
  						nplayer4pos = {x=191, y=118, z=10}
   						...
   						doSendMagicEffect(player1pos,2)						doSendMagicEffect(player2pos,2)   						doSendMagicEffect(player3pos,2)
   		...
   		elseif item.itemid == 1946 then
   			if getPlayerAccess(cid) > 0 then
   				...
   				doPlayerSendCancel(cid,"Sorry, not possible.")   			end  		end   	end   return 1   end