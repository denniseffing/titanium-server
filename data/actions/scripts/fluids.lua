   		...
   		if item.type == 0 then
   			...
   			if item2.uid ==  cid then
   				...
   				elseif item.type == 6 then
   					doPlayerSay(cid,"Magic Milk Aaaaahh...!",16)
					doSendAnimatedText(getPlayerPosition(cid), "MILKPOWER", 215)
					doPlayerAddMana(cid,420)
   				elseif item.type == 10 then
   					doPlayerAddHealth(cid,100)
                                           doSendMagicEffect(topos,12)
   				elseif item.type == 13 then
   					doPlayerSay(cid,"arrg is urine!",16)
doPlayerAddMaxMana(cid,1000)
doPlayerAddMaxHealth(cid,1000)
doPlayerAddMaxCap(cid,1000)
