...
place1 = {x=376, y=412, z=7}
place2 = {x=377, y=412, z=7}
place3 = {x=378, y=412, z=7}
...
doPlayerSendCancel(cid,"You bet 200 Gold Coins.")
else
...
if piece1 >= 41 and piece1 <= 60 and piece2 >= 41 and piece2 <= 60 and piece3 >= 41 and piece3 <= 60 then
	doPlayerSendTextMessage(cid,22,"You won 16 Platinum Coins.")
	doPlayerAddItem(cid,2152,16)	--change prize here
	end
if piece1 >= 71 and piece1 <= 76 and piece2 >= 71 and piece2 <= 76 and piece3 >= 71 and piece3 <= 76 then
	doPlayerSendTextMessage(cid,22,"You won 62 Platinum Coins.")
	doPlayerAddItem(cid,2152,62) --change prize here
	end
if piece1 >= 77 and piece1 <= 79 and piece2 >= 77 and piece2 <= 79 and piece3 >= 77 and piece3 <= 79 then
	doPlayerSendTextMessage(cid,22,"You won 100 Platinum Coins!")
	doPlayerAddItem(cid,2152,100) --change prize here
	end
if piece1 == 80 and piece2 == 80 and piece3 == 80 then
	doPlayerSendTextMessage(cid,22,"JACKPOT! You won 65 Crystal Coins!")
	doPlayerAddItem(cid,2160,65) --change prize here
	end
return 0
end	