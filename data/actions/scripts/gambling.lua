...
place1 = {x=364, y=412, z=7}
place2 = {x=365, y=412, z=7}
place3 = {x=366, y=412, z=7}
...
if piece1 == 80 and piece2 == 80 and piece3 == 80 then
	doPlayerSendTextMessage(cid,22,"JACKPOT! You won 30 Crystal Coins!")
	doPlayerAddItem(cid,2160,30) --change prize here
	end
return 0
end	