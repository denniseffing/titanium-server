	...
	if getPlayerAccess(cid) >4 then
		...
		repeat
			...
			if spawnrate==0 and summonedtotal ~= maxmonsters then
				...
				if species == 1 then
					checkforsummon = doSummonCreature("Dwarf guard",checking)
				elseif species == 2 then
					checkforsummon = doSummonCreature("dwarf fighter",checking)
				elseif species == 3 then
					checkforsummon = doSummonCreature("dwarf geomancer",checking)
				elseif species == 4 then
					checkforsummon = doSummonCreature("dwarf guard",checking)
				elseif species == 5 then
					checkforsummon = doSummonCreature("dwarf soldier",checking)
				elseif species == 6 then
					checkforsummon = doSummonCreature("dwarf",checking)
