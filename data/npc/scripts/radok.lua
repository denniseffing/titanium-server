focus = 0
 ...
 function onCreatureSay(cid, type, msg)
  	...
  	if ((string.find(msg, '(%a*)hi(%a*)')) and (focus == 0)) and getDistanceToCreature(cid) < 4 then
  		selfSay('Hello ' .. creatureGetName(cid) .. '! Im the Capitan Radok the famous pirate hunter...Ruffy i will catch u!!!..... I can take you to Gaia (300gps), old city(500gps), Sky island(800gps) and Port Hope (300gps) sillent village 400 gp. Where do you want to go?')
  		focus = cid
  		talk_start = os.clock()
  	end
