focus = 0
 ...
 function onCreatureSay(cid, type, msg)
  	...
  	if ((string.find(msg, '(%a*)hi(%a*)')) and (focus == 0)) and getDistanceToCreature(cid) < 4 then
  		selfSay('Hello ' .. creatureGetName(cid) .. '! I can take you to Gaia(300gps), Sky Island (200gps) or Radoka (500gps)and Port Hope (300gps) silent village 400gp. . Where do you want to go?')
  		focus = cid
  		talk_start = os.clock()
  	end
