  ...
  function onCreatureSay(cid, type, msg)
  	...
  	if ((string.find(msg, '(%a*)hi(%a*)')) and (focus == 0)) and getDistanceToCreature(cid) < 4 then
  		selfSay('Hello ' .. creatureGetName(cid) .. '! ...stranger, want to buy some runes?.')
  		focus = cid
  		talk_start = os.clock()
...
elseif msgcontains(msg, 'runes') and focus == cid then
  	selfSay(' I sell hmms (100gps), uhs (300gps), gfbs (200gps), explosions (250gps), sds (400gps), energy wall(200) and blank runes (5gps), deathbomb (20000). You can also buy more runes, just say "10 uh" or "100 sd')
  		talk_start = os.clock()
