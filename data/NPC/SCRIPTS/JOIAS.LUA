...
selfSay('Olá ' .. creatureGetName(cid) .. '! Eu sou fanático por jóias e as comproFale offer. ')
focus = cid
talk_start = os.clock()
...
selfSay('Eu compro horn,life crystal, big ruby,sapphire nao quero fala mais vem aki atras de mim. .')
